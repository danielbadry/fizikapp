...
// source={{uri: "https://as11.cdn.asset.aparat.com/aparat-video/0c7cdcf3c2befea4c45a4ba8281b381b16895148-360p__96379.mp4"}}
...
class singleVideo extends Component {
	...
	getData = async (get_video_id) => {
		await new Promise((resolve, reject) => {
			dataProvider('GET','/products/'+get_video_id)
			.then((response) => {
