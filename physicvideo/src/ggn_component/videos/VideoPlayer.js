...
export default class VideoPlayer extends Component {
    ...
    */
    ...
    _onLoad( data = {} ) {
        ...
        if(this.props.sartofvideo !== "" && this.props.sartofvideo !== 0 && this.props.sartovideo !== undefined){
            this.seekTo(this.props.sartofvideo);
        }
    ...
    */
    ...
    renderTopControls() {
        ...
        return(
            <Animated.View style={[
                ...
                <ImageBackground
                    source={ require( '../../images/VideoPlayer/img/top-vignette.png' ) }
    ...
    renderBack() {
        ...
        return this.renderControl(
            <Image
                source={ require( '../../images/VideoPlayer/img/back.png' ) }
    ...
    renderVolume() {
        ...
        return (
            <View style={ styles.volume.container }>
                ...
                >
                    <Image style={ styles.volume.icon } source={ require( '../../images/VideoPlayer/img/volume.png' ) } />
                </View>
            </View>
        );
    }
    ...
    renderFullscreen() {
        ...
        let source = this.state.isFullscreen === true ? require( '../../images/VideoPlayer/img/shrink.png' ) : require( '../../images/VideoPlayer/img/expand.png' );
        return this.renderControl(
            <Image source={ source } />,
            this.methods.toggleFullscreen,
    ...
    renderBottomControls() {
        ...
        return(
            <Animated.View style={[
                ...
                <ImageBackground
                    source={ require( '../../images/VideoPlayer/img/bottom-vignette.png' ) }
                    style={[ styles.controls.column ]}
                    imageStyle={[ styles.controls.vignette ]}>
                    { seekbarControl }
                    <View style={[
    ...
    renderSeekbar() {
        ...
        return (
            <View style={ styles.seekbar.container }>
                <View style={ styles.seekbar.track } onLayout={ event => this.player.seekerWidth = event.nativeEvent.layout.width } >
                    <View style={[
                        styles.seekbar.fill,
                        {
    ...
    renderPlayPause() {
        ...
        let source = this.state.paused === true ? require( '../../images/VideoPlayer/img/play.png' ) : require( '../../images/VideoPlayer/img/pause.png' );
        return this.renderControl(
            <Image source={ source } />,
        ...
        if ( this.state.loading ) {
            return (
                <View style={ styles.loader.container }>
                    <Animated.Image source={ require( '../../images/VideoPlayer/img/loader-icon.png' ) } style={[
                        styles.loader.icon,
                        { transform: [
        ...
        if ( this.state.error ) {
            return (
                <View style={ styles.error.container }>
                    <Image source={ require( '../../images/VideoPlayer/img/error-icon.png' ) } style={ styles.error.icon } />
